...
public class ExcelData1 {
...

	{
		...
		File file = new File(".\\DataExcel\\NewExcel.xlsx");

		FileInputStream fileInput = new FileInputStream(file);

		XSSFWorkbook wb = new XSSFWorkbook(fileInput);

		XSSFSheet sh = wb.getSheet("LoginDetails");
		XSSFSheet sh1 = wb.getSheet("EmpDetails");
...

		{
			...
			action.moveToElement(driver.findElement(
					By.xpath("//div[@class='orangehrm-header-container']/button[normalize-space(text()='Add')]")))
					.click();
			...
			driver.findElement(By.xpath("//input[@placeholder='Last Name']"))
					.sendKeys(row.getCell(2).getStringCellValue());
			...
			driver.findElement(By.xpath("(//input[@class='oxd-input oxd-input--active'])[3]"))
					.sendKeys(row.getCell(3).getStringCellValue());
			System.out.print(row.getCell(3).getStringCellValue()+" | ");

			// password
			driver.findElement(By.xpath(
					"(//div[@class='oxd-input-group oxd-input-field-bottom-space']/div[2]/input[contains(@type,password)])[7]"))
					.sendKeys(row.getCell(4).getStringCellValue());
			System.out.print(row.getCell(4).getStringCellValue()+" | ");
			Thread.sleep(2000);
			// confirm password
			driver.findElement(By.xpath(
					"(//div[@class='oxd-input-group oxd-input-field-bottom-space']/div[2]/input[contains(@type,password)])[8]"))
					.sendKeys(row.getCell(5).getStringCellValue());
			...
			Thread.sleep(3000);
			action.moveToElement(driver.findElement(
					By.xpath("//div[@class='orangehrm-header-container']/button[normalize-space()='Add']"))).click();
			action.build().perform();
			// User role
			Thread.sleep(3000);
			WebElement usr_rle = driver
					.findElement(By.xpath("(//div[@class='oxd-select-wrapper'])[1]/div/div[text()='-- Select --']"));
			usr_rle.click();
			...
			empnme.sendKeys(row.getCell(6).getStringCellValue());
			...
			WebElement status = driver
					.findElement(By.xpath("(//div[@class='oxd-select-wrapper'])[2]/div/div[text()='-- Select --']"));
			status.click();
			status.sendKeys(Keys.DOWN);
			status.sendKeys(Keys.ENTER);
			// Username
			driver.findElement(By.xpath(
					"(//div[@class='oxd-input-group oxd-input-field-bottom-space'])[4]/div[2]/input[@class='oxd-input oxd-input--active']"))
					.sendKeys(row.getCell(7).getStringCellValue());
			System.out.print(row.getCell(7).getStringCellValue()+" | ");
			// Password
			Thread.sleep(3000);
			driver.findElement(By.xpath(
					"(//div[@class='oxd-input-group oxd-input-field-bottom-space'])[5]/div[2]/input[@type='password']"))
					.sendKeys(row.getCell(8).getStringCellValue());
			System.out.print(row.getCell(8).getStringCellValue());
			// confirm Password
			driver.findElement(By.xpath(
					"(//div[@class='oxd-input-group oxd-input-field-bottom-space'])[6]/div[2]/input[@type='password']"))
					.sendKeys(row.getCell(9).getStringCellValue());
			System.out.print("confirm Password is: " + row.getCell(9).getStringCellValue()+" | ");
			// Save
			Thread.sleep(3000);
